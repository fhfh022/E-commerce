...
const Footer = () => {
    ...
    return (
        <footer className="mx-6 bg-white transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 dark:border-slate-800 text-slate-500 dark:text-slate-400">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700 dark:text-slate-100">
                            <span className="text-green-600 dark:text-green-500">PR</span>T<span className="text-green-600 dark:text-green-500 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <div className="flex items-center gap-3 mt-5">
                            {socialIcons.map((item, i) => (
                                <Link href={item.link} key={i} className="flex items-center justify-center w-10 h-10 bg-slate-100 dark:bg-slate-800 hover:scale-105 hover:border border-slate-300 dark:border-slate-700 transition rounded-full text-slate-600 dark:text-slate-300">
                                    <item.icon />
                                </Link>
                            ))}
                        </div>
                ...
                <p className="py-4 text-sm text-slate-500 dark:text-slate-500">
