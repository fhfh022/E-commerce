...
const AdminNavbar = () => {
    return (
        <div className="flex items-center justify-between px-4 sm:px-12 py-3 border-b border-slate-200 transition-all bg-white">
            {/* Logo */}
            <Link href="/" className="relative text-2xl sm:text-4xl font-semibold text-slate-700">
                ...
                <p className="absolute text-xs font-semibold -top-1 -right-6 sm:-right-13 px-3 p-0.5 rounded-full flex items-center gap-2 text-white bg-green-500">
                    Admin
                </p>
            </Link>
            ...
            >
                <Store size={18} /> ไปที่ Store Dashboard
            </Link>
        </div>
    )
}
