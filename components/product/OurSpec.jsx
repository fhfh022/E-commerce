...
const OurSpecs = () => {
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      <Title
        visibleButton={false}
        title="มาตรฐานการบริการของเรา"
        description="เรามุ่งมั่นมอบบริการที่เหนือระดับ เพื่อให้ทุกการสั่งซื้อของคุณเป็นเรื่องง่าย ปลอดภัย และได้รับประสบการณ์ที่ดีที่สุด"
      />
